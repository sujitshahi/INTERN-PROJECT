      ...
      <section className="w-full bg-[#FFFDF9] text-slate-900 py-16 lg:py-24 relative overflow-hidden font-sans">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 space-y-16">
            ...
            {CONTACT_DETAILS.map((item) => {
              ...
              return (
                <m.div
                  ...
                  whileHover={{ y: -6 }}
                  className="bg-white border border-slate-200/80 rounded-3xl p-6 flex flex-col items-center text-center shadow-xs hover:shadow-md transition-colors"
                >
          ...
          >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      className={`w-full p-4 rounded-2xl bg-slate-50 border text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-[#FE5D37] transition-colors resize-none ${
                  ...
                  <Button
                    type="submit"
                    className="w-full py-6 bg-[#FE5D37] text-white font-extrabold text-base rounded-2xl hover:bg-[#e45230] shadow-lg shadow-[#FE5D37]/20 transition-colors cursor-pointer flex items-center justify-center gap-2 group"
                  >
            ...
            <div className="lg:col-span-5 rounded-3xl overflow-hidden border border-slate-200/80 shadow-lg min-h-87.5 lg:min-h-full relative bg-slate-100">
              <iframe
