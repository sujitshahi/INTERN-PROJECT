          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-24 gap-x-12 justify-items-center pb-10">
            {teachers.map((teacher, index) => (
              ...
              >
                ...
                <div className="absolute -bottom-12 -right-2 sm:-right-4 w-56 h-56 rounded-full border-10 border-[#FFFDF9] bg-white flex flex-col items-center justify-center text-center shadow-xl transition-colors duration-300 hover:border-orange-100 group">
                  ...
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      className="w-8 h-8 rounded-full bg-[#FE5D37] text-white flex items-center justify-center hover:bg-[#e45230] hover:scale-110 transition-colors shadow-xs"
                    >
