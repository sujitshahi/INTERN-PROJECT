          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Button
                ...
                className="bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-full px-8 py-6 text-base shadow-lg shadow-orange-500/20 transition-transform hover:scale-105 cursor-pointer"
              >
                Explore Our Classes
              </Button>
              <Button
                ...
                variant="light"
                className="text-slate-700 hover:text-orange-600 font-bold rounded-full px-6 py-6 text-base cursor-pointer"
              >
                Learn More →
              </Button>
            </div>
