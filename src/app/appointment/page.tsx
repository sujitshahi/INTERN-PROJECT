  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto my-12 px-4">
      <div className="flex flex-col md:flex-row rounded-4xl overflow-hidden shadow-sm">
        ...
        <div className="flex-1 bg-[#FFF5F3] p-4">
        ...
        <div className="flex-1 relative min-h-100">
          <img src="https://themewagon.github.io/kider/img/appointment.jpg"  alt="" className="absolute inset-0 w-full h-full object-cover" />
        </div>
      </div>
