...
export default function Testimonial() {
  ...
  if (!autoplayPlugin.current) {
    autoplayPlugin.current = Autoplay({ delay: 3500, stopOnInteraction: false });
  }
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          >
            ...
            >
              ...
              <CarouselPrevious className="-left-4 sm:-left-6 h-11 w-11 rounded-full bg-[#FE5D37] text-white hover:bg-[#e45230] hover:text-white border-none shadow-md transition-colors cursor-pointer" />
              <CarouselNext className="-right-4 sm:-right-6 h-11 w-11 rounded-full bg-[#FE5D37] text-white hover:bg-[#e45230] hover:text-white border-none shadow-md transition-colors cursor-pointer" />
            </Carousel>
          </m.div>
        </div>
      </section>
